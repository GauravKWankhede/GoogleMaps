...
<!-- blaze-out/k8-opt/genfiles/java/com/google/android/gmscore/integ/client/base/res/values-de/strings.xml -->
<eat-comment/>
...
<string name="common_google_play_services_notification_channel_name" msgid="4293541511340436975">"Verfügbarkeit von Google Play-Diensten"</string>
...
<string name="common_google_play_services_updating_text" msgid="7894275749778928941">"Zur Nutzung von <xliff:g id="APP_NAME">%1$s</xliff